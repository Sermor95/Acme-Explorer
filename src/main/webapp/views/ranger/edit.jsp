...
<spring:message code="ranger.create" var="create" />
<spring:message code="ranger.userAccount.username" var="username" />
<spring:message code="ranger.userAccount.password" var="password" />
...
<spring:message code="ranger.address" var="address" />
<spring:message code="ranger.save" var="save" />
<spring:message code="ranger.cancel" var="cancel" />
<spring:message code="ranger.phone.check" var="check" />

<security:authorize access="isAnonymous() or hasRole('ADMIN') or isAuthenticated()">

<form:form id="form" action="${requestURI}" modelAttribute="ranger">
	...
	<%-- Buttons --%>
	<input type="submit" name="save" value="${save}" onclick="phoneCheck()"/>&nbsp; 
