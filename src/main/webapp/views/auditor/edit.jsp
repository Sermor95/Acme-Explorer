...
<spring:message code="auditor.create" var="create" />
...
<spring:message code="auditor.surname" var="surname" />
...
<form:form id="form" action="${requestURI}" modelAttribute="auditor">
